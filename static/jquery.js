...
!(function(a, b) {
	...
	(r.fn = r.prototype = {
		...
		r.extend({
			...
			type: function(a) {
				return null == a
					? a + ''
					: 'object' == typeof a || 'function' == typeof a ? j[k.call(a)] || 'object' : typeof a;
			},
	...
	var x = (function(a) {
		var b,
			...
			ca = function(a, b) {
				return b
					? '\0' === a ? '\ufffd' : a.slice(0, -1) + '\\' + a.charCodeAt(a.length - 1).toString(16) + ' '
					: '\\' + a;
			},
			da = function() {
				m();
			...
			return function(b) {
				return 'form' in b
					? b.parentNode && b.disabled === !1
						? 'label' in b
							? 'label' in b.parentNode ? b.parentNode.disabled === a : b.disabled === a
	...
	var F,
		...
		H = (r.fn.init = function(a, b, c) {
			...
			return a.nodeType
				...
				: r.isFunction(a) ? (void 0 !== c.ready ? c.ready(a) : a(r)) : r.makeArray(a, this);
		});
	...
	r.fn.extend({
		...
		index: function(a) {
			return a
				? 'string' == typeof a ? i.call(r(a), this[0]) : i.call(this, a.jquery ? a[0] : a)
	...
	function P(a, b, c, d) {
		...
		try {
			a && r.isFunction((e = a.promise))
				...
				: a && r.isFunction((e = a.then)) ? e.call(a, b, c) : b.apply(void 0, [ a ].slice(d));
		} catch (a) {
			c.apply(void 0, [ a ]);
		}
	}
				...
				r.fn[d] = function(e, f) {
					...
					return T(
						...
						function(b, c, e) {
							var f;
							return r.isWindow(b)
								? 0 === d.indexOf('outer') ? b['inner' + a] : b.document.documentElement['client' + a]
								: 9 === b.nodeType
									? ((f = b.documentElement),
										Math.max(
											b.body['scroll' + a],
